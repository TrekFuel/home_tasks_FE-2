/* eslint-disable */
describe('tdd-home.js -> positiveSum -> should find sum of positive number' +
    ' in array', function () {
...
describe('tdd-home.js -> evenOrOdd -> should return strings \'Even\' or' +
    '  \'Odd\'', function () {
  it('Base test', function () {
...
describe('tdd-home.js -> It should remove all values from list a, which are' +
    ' present in list b', function () {
